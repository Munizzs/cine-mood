...
public class Historico extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String[] lancamentoTitulo = {"Barbie", "Oppenheimer", "Five Nights at Freddy's"};
        List<Movie> movies = fetchMoviesFromApi(lancamentoTitulo, apiKey);

        String[] recommendedTitles = {"Inception", "Deadpool 2", "Inside out 2"};
