...
public class CreateListFilmController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println(id_usuario+" | "+id_filme+" | "+status+" | "+avaliacao+" | "+data_adicao);

        try {
            System.out.println(id_usuario+" | "+id_filme+" | "+status+" | "+avaliacao+" | "+data_adicao);
            ListaFilme listafilme= new ListaFilme(id_usuario,id_filme,status,avaliacao,data_adicao);
